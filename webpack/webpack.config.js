...
module.exports = function makeWebpackConfig(options) {
    ...
    if (options.parameters.dev_server_public_path && DEV_SERVER) {
        ...
        publicPath = DEV_SERVER ? 'http://localhost:8080/compiled/' : '/dist/';
    }
    ...
    var config = {
        ...
        output: {
            ...
            path: options.parameters.path ? options.parameters.path : __dirname + '/../web/dist/',
    ...
    config.module = {
        rules: [
             ...
             */
            {
                test: /\.(png|jpg|jpeg|gif|svg|woff|woff2|ttf|eot|pdf)(\?.*)?$/i,
                loader: 'file-loader',
                options: {
                    name: '[name].[hash].[ext]'
                }
    ...
    config.plugins = [
        ...
        new webpack.ProvidePlugin({
                ...
                Alert: "exports-loader?Alert!wbootstrap/js/dist/alert",
