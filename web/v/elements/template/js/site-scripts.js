    ...
    $('[data-popup-form-chooser]').on('submit', function (e) {
        ...
        if (targetEl) {
            ...
            $(formFields).each(function (index, item) {
                var value = $(item).val();
                var item = $('<div class="site-tag-element js--site-tag-element">' + '<a href="javascript:void(0);" class="site-tag-element-close js--ste-close"></a>' + value + '<input type="hidden" name="' + inputName + '" value="' + value + '">' + '</div>');
